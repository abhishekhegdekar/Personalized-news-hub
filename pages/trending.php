...
<div class="section">
  <div class="section__title">More trending stories</div>
  <div data-news-mount data-mode="trending"></div>
</div>

<script>
  (async () => {
    const hero = document.getElementById('heroTrend');
    ...
    try {
          ...
          <div class="hero__body">
            ...
            <div class="hero__cta">
              ...
              <button class="btn btn--ghost btn--sm"
                ...
                data-category="${escapeAttr(first.category || 'news')}"
      ...
      hero.innerHTML = `<div class="panel">Couldn’t load featured story.</div>`;
